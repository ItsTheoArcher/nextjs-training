...
export default function Home() {
  return (
    <>
      <main className="max-w-screen-md mx-auto px-6 py-6 relative min-h-screen font-light">
        <section className="flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="font-semibold text-slate-800 dark:text-gray-300 text-sm">
        ...
        <section className="my-9 text-sm">
          ...
          <div className="text-slate-800 dark:text-gray-300">
        ...
        <section className="my-9 text-sm">
          <h2 className="text-lg mb-2 text-slate-900 dark:text-slate-200">Contact</h2>
            ...
            {generalData.contacts.map((contact, index) => {
              return (
                <div className="flex" key={index}>
                  ...
                  <div className="flex flex-col flex-1 text-slate-900 dark:text-slate-200">
                    <a
                      href={contact.href}
                      target="_blank"
                      rel="noopener noreferrer"
