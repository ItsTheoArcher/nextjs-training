    ...
    <>
      <main className="max-w-xl mx-auto px-6 py-20 relative min-h-screen font-light">
        <section className="flex items-center">
          ...
          <div className="ml-4">
            <h1 className="mb-0.5 text-xl text-slate-900 font-bold">
              {generalData.name}
            </h1>
        ...
        <section className="my-9 text-sm">
          <h2 className="text-lg mb-1 text-slate-900">About</h2>
            ...
            {generalData.contacts.map((contact, index) => {
              return (
                <div className="flex" key={index}>
                  <div className="mr-8 max-w-[100px] w-full text-slate-600">
                    {contact.label}
                  </div>
